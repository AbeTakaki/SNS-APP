      ...
      <div className="relative">
        <header className="fixed bg-gray-200 max-w-screen-md w-full pl-8 pr-8 h-24 opacity-90">
          <div className="flex justify-between items-center p-6">
            <Link href="/xweet">
              <h1 className="left-1 text-center text-black text-4xl font-bold">Xweet</h1>
            </Link>

            {isLogin ? (
              <nav>
                <ul className="flex space-x-4">
                  <li><Link href="/xweet/create" className="text-center text-gray-500 hover:text-black">Create</Link></li>
