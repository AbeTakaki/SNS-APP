<div class="relative">
    <header class="fixed bg-gray-200 max-w-screen-md w-full pl-8 pr-8 h-24 opacity-90">
        ...
        <div class="flex justify-between items-center p-6">
            ...
            <a href="/xweet">
                <h1 class="left-1 text-center text-black text-4xl font-bold">Xweet</h1>
            </a>
            ...
            @auth
                ...
                <nav>
                    <ul class="flex space-x-4">
                        <li><a href="{{route('xweet.create')}}" class="text-center text-gray-500 hover:text-black">Create</a></li>
